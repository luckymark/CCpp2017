#include"Include\ShadersEffect.h"
...
void ShadersEffect::apply(const sf::RenderTexture& input, sf::RenderTarget& output)
{
...
void ShadersEffect::prepareTextures(sf::Vector2u size)
{
...
void ShadersEffect::filterBright(const sf::RenderTexture& input, sf::RenderTexture& output)
{
...
void ShadersEffect::blurMultipass(RenderTextureArray& renderTextures)
{
...
void ShadersEffect::blur(const sf::RenderTexture& input, sf::RenderTexture& output, sf::Vector2f offsetFactor)
{
...
void ShadersEffect::downsample(const sf::RenderTexture& input, sf::RenderTexture& output)
{
...
void ShadersEffect::add(const sf::RenderTexture& source, const sf::RenderTexture& bloom, sf::RenderTarget& output)
{
