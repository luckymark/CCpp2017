/******************************************************************************************
  ...
  5) 进一步的，我想到了可以使用全局的队列来维护所有东西发生的顺序,这些东西，就像这个世界的法则。

  6) 所以，之后我会实现一个全局的队列(Director)来对所有的时间进行操作。让所有的事都圆满的解决吧。
     这个类的名字暗示着对游戏中一切事件的掌控。2333333

  7) 其实还可以对Animation类做进一步的抽象，但是现在暂时不想
  8) 最后，我们将Animation类之间的接触判断，下放到Frame类来计算
******************************************************************************************/
#ifndef FRAME_H_
#define FRAME_H_
